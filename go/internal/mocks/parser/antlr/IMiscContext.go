...
// IMiscContext is an autogenerated mock type for the IMiscContext type
type IMiscContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IMiscContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IMiscContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IMiscContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IMiscContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IMiscContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IMiscContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IMiscContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IMiscContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IMiscContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IMiscContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IMiscContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IMiscContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IMiscContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IMiscContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IMiscContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IMiscContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IMiscContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IMiscContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IMiscContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IMiscContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IMiscContext) GetText() string {
	ret := _m.Called()
...
func (_m *IMiscContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsMiscContext provides a mock function with given fields:
func (_m *IMiscContext) IsMiscContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IMiscContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IMiscContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IMiscContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IMiscContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IMiscContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IMiscContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IMiscContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IMiscContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IMiscContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
