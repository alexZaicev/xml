...
// IChardataContext is an autogenerated mock type for the IChardataContext type
type IChardataContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IChardataContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IChardataContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IChardataContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IChardataContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IChardataContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IChardataContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IChardataContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IChardataContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IChardataContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IChardataContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IChardataContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IChardataContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IChardataContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IChardataContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IChardataContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IChardataContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IChardataContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IChardataContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IChardataContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IChardataContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IChardataContext) GetText() string {
	ret := _m.Called()
...
func (_m *IChardataContext) GetValue() antlr.Token {
	ret := _m.Called()
...
// IsChardataContext provides a mock function with given fields:
func (_m *IChardataContext) IsChardataContext() {
	_m.Called()
}

// IsEmpty provides a mock function with given fields:
func (_m *IChardataContext) IsEmpty() bool {
	ret := _m.Called()
...
func (_m *IChardataContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IChardataContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IChardataContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IChardataContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IChardataContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IChardataContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IChardataContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetValue provides a mock function with given fields: _a0
func (_m *IChardataContext) SetValue(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IChardataContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IChardataContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
