...
// IAttributeContext is an autogenerated mock type for the IAttributeContext type
type IAttributeContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IAttributeContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IAttributeContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IAttributeContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IAttributeContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IAttributeContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IAttributeContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IAttributeContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IAttributeContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IAttributeContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IAttributeContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IAttributeContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IAttributeContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IAttributeContext) GetName() antlr.Token {
	ret := _m.Called()
...
func (_m *IAttributeContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IAttributeContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IAttributeContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IAttributeContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IAttributeContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IAttributeContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IAttributeContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IAttributeContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IAttributeContext) GetText() string {
	ret := _m.Called()
...
func (_m *IAttributeContext) GetValue() antlr.Token {
	ret := _m.Called()
...
// IsAttributeContext provides a mock function with given fields:
func (_m *IAttributeContext) IsAttributeContext() {
	_m.Called()
}

// IsEmpty provides a mock function with given fields:
func (_m *IAttributeContext) IsEmpty() bool {
	ret := _m.Called()
...
func (_m *IAttributeContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IAttributeContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IAttributeContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IAttributeContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetName provides a mock function with given fields: _a0
func (_m *IAttributeContext) SetName(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IAttributeContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IAttributeContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IAttributeContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetValue provides a mock function with given fields: _a0
func (_m *IAttributeContext) SetValue(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IAttributeContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IAttributeContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
