...
// IDocumentContext is an autogenerated mock type for the IDocumentContext type
type IDocumentContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IDocumentContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IDocumentContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IDocumentContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IDocumentContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IDocumentContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IDocumentContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IDocumentContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IDocumentContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IDocumentContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IDocumentContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IDocumentContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IDocumentContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IDocumentContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IDocumentContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IDocumentContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IDocumentContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IDocumentContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IDocumentContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IDocumentContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IDocumentContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IDocumentContext) GetText() string {
	ret := _m.Called()
...
// IsDocumentContext provides a mock function with given fields:
func (_m *IDocumentContext) IsDocumentContext() {
	_m.Called()
}

// IsEmpty provides a mock function with given fields:
func (_m *IDocumentContext) IsEmpty() bool {
	ret := _m.Called()
...
func (_m *IDocumentContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IDocumentContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IDocumentContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IDocumentContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IDocumentContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IDocumentContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IDocumentContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IDocumentContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IDocumentContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
