...
// IReferenceContext is an autogenerated mock type for the IReferenceContext type
type IReferenceContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IReferenceContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IReferenceContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IReferenceContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IReferenceContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IReferenceContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IReferenceContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IReferenceContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IReferenceContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IReferenceContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IReferenceContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IReferenceContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IReferenceContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IReferenceContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IReferenceContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IReferenceContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IReferenceContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IReferenceContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IReferenceContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IReferenceContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IReferenceContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IReferenceContext) GetText() string {
	ret := _m.Called()
...
func (_m *IReferenceContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsReferenceContext provides a mock function with given fields:
func (_m *IReferenceContext) IsReferenceContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IReferenceContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IReferenceContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IReferenceContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IReferenceContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IReferenceContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IReferenceContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IReferenceContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IReferenceContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IReferenceContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
