...
// IElementContext is an autogenerated mock type for the IElementContext type
type IElementContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IElementContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IElementContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IElementContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IElementContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IElementContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IElementContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IElementContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IElementContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
// GetBeginning provides a mock function with given fields:
func (_m *IElementContext) GetBeginning() antlr.Token {
	ret := _m.Called()
...
func (_m *IElementContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IElementContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IElementContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
// GetEnding provides a mock function with given fields:
func (_m *IElementContext) GetEnding() antlr.Token {
	ret := _m.Called()
...
func (_m *IElementContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IElementContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IElementContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IElementContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IElementContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IElementContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IElementContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IElementContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IElementContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IElementContext) GetText() string {
	ret := _m.Called()
...
// IsElementContext provides a mock function with given fields:
func (_m *IElementContext) IsElementContext() {
	_m.Called()
}

// IsEmpty provides a mock function with given fields:
func (_m *IElementContext) IsEmpty() bool {
	ret := _m.Called()
...
func (_m *IElementContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IElementContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetBeginning provides a mock function with given fields: _a0
func (_m *IElementContext) SetBeginning(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetEnding provides a mock function with given fields: _a0
func (_m *IElementContext) SetEnding(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetException provides a mock function with given fields: _a0
func (_m *IElementContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IElementContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IElementContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IElementContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IElementContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IElementContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IElementContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
