...
// IContentContext is an autogenerated mock type for the IContentContext type
type IContentContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IContentContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IContentContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IContentContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IContentContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IContentContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IContentContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IContentContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IContentContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IContentContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IContentContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IContentContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IContentContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IContentContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IContentContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IContentContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IContentContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IContentContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IContentContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IContentContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IContentContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IContentContext) GetText() string {
	ret := _m.Called()
...
// IsContentContext provides a mock function with given fields:
func (_m *IContentContext) IsContentContext() {
	_m.Called()
}

// IsEmpty provides a mock function with given fields:
func (_m *IContentContext) IsEmpty() bool {
	ret := _m.Called()
...
func (_m *IContentContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IContentContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IContentContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IContentContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IContentContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IContentContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IContentContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IContentContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IContentContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
