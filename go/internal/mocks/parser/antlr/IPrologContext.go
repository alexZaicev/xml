...
// IPrologContext is an autogenerated mock type for the IPrologContext type
type IPrologContext struct {
	mock.Mock
}

// Accept provides a mock function with given fields: Visitor
func (_m *IPrologContext) Accept(Visitor antlr.ParseTreeVisitor) interface{} {
...
func (_m *IPrologContext) AddChild(child antlr.RuleContext) antlr.RuleContext {
	ret := _m.Called(child)
...
func (_m *IPrologContext) AddErrorNode(badToken antlr.Token) *antlr.ErrorNodeImpl {
...
func (_m *IPrologContext) AddTokenNode(token antlr.Token) *antlr.TerminalNodeImpl {
	ret := _m.Called(token)
...
func (_m *IPrologContext) EnterRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// ExitRule provides a mock function with given fields: listener
func (_m *IPrologContext) ExitRule(listener antlr.ParseTreeListener) {
	_m.Called(listener)
}

// GetAltNumber provides a mock function with given fields:
func (_m *IPrologContext) GetAltNumber() int {
	ret := _m.Called()
...
func (_m *IPrologContext) GetBaseRuleContext() *antlr.BaseRuleContext {
	ret := _m.Called()
...
func (_m *IPrologContext) GetChild(i int) antlr.Tree {
	ret := _m.Called(i)
...
func (_m *IPrologContext) GetChildCount() int {
	ret := _m.Called()
...
func (_m *IPrologContext) GetChildren() []antlr.Tree {
	ret := _m.Called()
...
func (_m *IPrologContext) GetInvokingState() int {
	ret := _m.Called()
...
func (_m *IPrologContext) GetParent() antlr.Tree {
	ret := _m.Called()
...
func (_m *IPrologContext) GetParser() antlr.Parser {
	ret := _m.Called()
...
func (_m *IPrologContext) GetPayload() interface{} {
	ret := _m.Called()
...
func (_m *IPrologContext) GetRuleContext() antlr.RuleContext {
	ret := _m.Called()
...
func (_m *IPrologContext) GetRuleIndex() int {
	ret := _m.Called()
...
func (_m *IPrologContext) GetSourceInterval() *antlr.Interval {
	ret := _m.Called()
...
func (_m *IPrologContext) GetStart() antlr.Token {
	ret := _m.Called()
...
func (_m *IPrologContext) GetStop() antlr.Token {
	ret := _m.Called()
...
func (_m *IPrologContext) GetText() string {
	ret := _m.Called()
...
func (_m *IPrologContext) IsEmpty() bool {
	ret := _m.Called()
...
// IsPrologContext provides a mock function with given fields:
func (_m *IPrologContext) IsPrologContext() {
	_m.Called()
}

// RemoveLastChild provides a mock function with given fields:
func (_m *IPrologContext) RemoveLastChild() {
	_m.Called()
}

// SetAltNumber provides a mock function with given fields: altNumber
func (_m *IPrologContext) SetAltNumber(altNumber int) {
	_m.Called(altNumber)
}

// SetException provides a mock function with given fields: _a0
func (_m *IPrologContext) SetException(_a0 antlr.RecognitionException) {
	_m.Called(_a0)
}

// SetInvokingState provides a mock function with given fields: _a0
func (_m *IPrologContext) SetInvokingState(_a0 int) {
	_m.Called(_a0)
}

// SetParent provides a mock function with given fields: _a0
func (_m *IPrologContext) SetParent(_a0 antlr.Tree) {
	_m.Called(_a0)
}

// SetStart provides a mock function with given fields: _a0
func (_m *IPrologContext) SetStart(_a0 antlr.Token) {
	_m.Called(_a0)
}

// SetStop provides a mock function with given fields: _a0
func (_m *IPrologContext) SetStop(_a0 antlr.Token) {
	_m.Called(_a0)
}

// String provides a mock function with given fields: _a0, _a1
func (_m *IPrologContext) String(_a0 []string, _a1 antlr.RuleContext) string {
...
func (_m *IPrologContext) ToStringTree(_a0 []string, _a1 antlr.Recognizer) string {
	ret := _m.Called(_a0, _a1)
